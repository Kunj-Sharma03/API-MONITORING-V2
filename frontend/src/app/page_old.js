...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0c0c10] via-[#101014] to-[#141418] text-white overflow-hidden relative">
      {/* Scroll Progress Indicator with Razer Green */}
      <div className="fixed top-0 left-0 w-full h-1 bg-white/5 z-50">
        <div className="h-full bg-gradient-to-r from-[#00ff88] via-[#44ff44] to-[#88ff88] transition-all duration-300 ease-out" 
             style={{width: `${scrollProgress}%`}}></div>
      </div>

      {/* DarkVeil Background with full screen coverage */}
      ...
      <nav className="relative z-20 glass-morphism border-b border-[#00ff88]/30">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center space-x-2 sm:space-x-3">
            <div className="p-1.5 sm:p-2 bg-gradient-to-br from-[#00ff88]/20 to-[#44ff44]/20 backdrop-blur-sm rounded-xl border border-[#00ff88]/40">
              <Eye className="w-6 h-6 sm:w-8 sm:h-8 text-[#00ff88]" />
            </div>
            <span className="text-xl sm:text-2xl font-bold text-[#ffffff] font-genz-display tracking-tight neon-text">
              EY3-API
            </span>
          </div>
          <div className="flex items-center space-x-2 sm:space-x-4">
            <Link href="/login" className="px-3 py-1.5 sm:px-4 sm:py-2 text-sm sm:text-base text-[#00ff88] hover:text-[#ffffff] transition-colors font-genz-accent tracking-wide font-semibold">
              &gt; SIGN_IN
            </Link>
            <Link href="/register" className="retro-button px-4 py-1.5 sm:px-6 sm:py-2 text-sm sm:text-base rounded-full transition-all font-genz-primary">
              NEURAL_LINK
            </Link>
          </div>
        </div>
      ...
      {/* Main Hero Section - Centered "Eye for API" with Retro Styling */}
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6">
        <div className="max-w-7xl mx-auto w-full text-center">
          <div className="relative">
            <SplitText
              text="EY3-API"
              className="text-4xl sm:text-6xl md:text-8xl lg:text-[8rem] font-black neon-text leading-tight font-genz-display tracking-tighter"
              splitType="chars"
              delay={100}
              duration={1.2}
              ...
              threshold={0.3}
            />
            <div className="mt-6 sm:mt-8 opacity-90">
              <p className="text-base sm:text-lg md:text-xl text-secondary font-genz-accent font-medium px-4 sm:px-0 tracking-wider">
                &gt; NEURAL API MONITORING SYSTEM v2.0 &lt;
              </p>
              <p className="text-sm sm:text-base text-green-300 font-genz-primary mt-2 opacity-80 font-semibold">
                [ REAL-TIME SURVEILLANCE • NEON ALERTS • CYBER ANALYTICS ]
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="flex flex-col items-center space-y-3 text-[#4a90e2]">
            <span className="text-sm font-orbitron font-medium tracking-wider">&gt; SCROLL &lt;</span>
            <div className="w-6 h-10 border border-[#4a90e2] rounded-full flex justify-center neon-glow">
